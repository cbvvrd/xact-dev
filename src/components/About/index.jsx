    ...
    return (
        <>
            <div className="flex flex-col items-center text-center gap-5 px-5 mt-10 py-7 bg-blue-100 md:px-48">
                ...
                <p className="md:text-lg">Xact Developments are here to help you find automation solutions. Facere iure quod recusandae modi at doloribus laudantium quasi optio tempora numquam laborum voluptatibus expedita, sunt, rerum sint! Animi modi qui iusto.</p>
                <SiLabview size={100}/>

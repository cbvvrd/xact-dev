    ...
    return (
        <>
            <div className="flex flex-col items-center text-center gap-5 px-5 mt-10 py-7 bg-blue-100 md:px-48">
                ...
                <p className="md:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere iure quod recusandae modi at doloribus laudantium quasi optio tempora numquam laborum voluptatibus expedita, sunt, rerum sint! Animi modi qui iusto.</p>
                <SiLabview size={100}/>
                ...
                <div className="bg-green-400 text-center mx-10 rounded-xl border-4 border-green-600 bg-opacity-50 p-1 md:mt-5">
